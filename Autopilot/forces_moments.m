...
function out = forces_moments(x, delta, wind, P)
    ...
    R_v_b = [c_tht*c_psi c_tht*s_psi -s_tht;...
    ...
    V_a_b = [u-V_w_b(1); v-V_w_b(2); w-V_w_b(3)];
    ...
    gForce =  [-ms*gr*s_tht; ms*gr*c_tht*s_phi; ms*gr*c_tht*c_phi];
    
    % Aerodynamic force (ensure aForce is a column vector)
    aForce = 0.5*P.rho*Va^2*P.S_wing.*...
    ...
    Torque = 0.5*P.rho*Va^2*P.S_wing.*...
